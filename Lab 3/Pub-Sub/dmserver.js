        ...
        if(element.toString() != ""){
            ...
            switch (invo.what) {
                case 'add user': 
			        ...
			        // pubsub.user = invo.u;
                    // pub.send(["webserver", JSON.stringify(pubsub)]);
                    break;
                ...
                case 'message': 
			        ...
			        // pubsub.to = invo.msg.to;
                    // pubsub.from = invo.msg.from;
                    // pubsub.ts = invo.msg.ts;
                    // pubsub.msg = invo.msg.msg;
                    // pubsub.isPrivate = invo.msg.isPrivate;
                    // pub.send(["webserver", JSON.stringify(pubsub)]);
                    break;

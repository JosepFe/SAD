...
//Mismo problema que en dmserver, se queda en bucle si añadimos directamente desde forum.
    ...
    if (res[i] != "" && res[i] != "cambios") {
      ...
      switch (msg.what) {
        ...
        case "add public message":
          io.emit("message", JSON.stringify(msg.msg)); //Aqui esta el error, no puedes imprimir solo el msg.
          break;
        default:
          console.log("error: actualizacion no valida" + res[i]);
      }
    }
  }
});
...
http.listen(PORTFORUM, on_startup);
